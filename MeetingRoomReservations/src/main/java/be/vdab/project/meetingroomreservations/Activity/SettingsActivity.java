...
public class SettingsActivity extends PreferenceActivity {
    ...
    private static String modeSummaryString, inputSummaryString;
    ...
    private void setupSimplePreferencesScreen() {
        ...
        modeSummaryString = getApplicationContext().getString(R.string.pref_summary_mode);
        inputSummaryString = getApplicationContext().getString(R.string.pref_summary_mode_input);
...
//
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            Log.e(TAG, "in onPreferenceChange");
            if (preference instanceof ListPreference) {
                // For list preferences, look up the correct display value in
                // the preference's 'entries' list.
                ListPreference listPreference = (ListPreference) preference;
                int index = listPreference.findIndexOfValue(stringValue);
                Log.e(TAG, "ListPreference: stringvalue: " + stringValue);
                // Set the summary to reflect the new value.
                preference.setSummary(
                        index >= 0
                                ? ( modeSummaryString + " " + listPreference.getEntries()[index]) // for some reason it doesn't take the space from the strings file
                                : null);
                Log.e(TAG, "setSummary: listPreference.getEntries()[index]" + (index >= 0
                        ? listPreference.getEntries()[index]
                        : ""));

            } else if (preference instanceof EditTextPreference) {
                EditTextPreference etPref = (EditTextPreference) preference;
                etPref.setSummary(inputSummaryString + " " + stringValue );
            }else
             {
    ...
    private static void bindPreferenceSummaryToValue(Preference preference) {
        Log.e(TAG, "in bindPreferenceSummaryToValue");
